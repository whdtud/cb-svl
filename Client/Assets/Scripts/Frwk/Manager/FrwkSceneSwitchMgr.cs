...
namespace Frwk
{
    public class FrwkSceneSwitchMgr : MonoBehaviour
    {
        #region UIPageData
        ...
        public void ClearAndPushPage(UIPageKind kind, PageBaseData pageData = null)
        {
        ...
        public void PushPage(UIPageKind kind, PageBaseData pageData = null)
        {
            if (kind == UIPageKind.None || kind == UIPageKind.MaxCount)
                return;
        ...
        public void PushAdditivePage(UIPageKind kind, PageBaseData pageData = null)
        {
            if (kind == UIPageKind.None || kind == UIPageKind.MaxCount)
                return;
